...
for($i = 0; $i < count($guildInfo); $i++) {
	...
	$stmt = $conn->prepare("
		INSERT INTO members (name, realm, role, class, level, ilvl, ring_max, heroics, head, neck, shoulder, back, chest, wrist, hands, waist, legs, feet, ring1, ring2, trinket1, trinket2, mainhand, offhand, enchant_weapon, enchant_neck, enchant_cloak, enchant_ring1, enchant_ring2, highmaul_kills_normal, highmaul_kills_heroic, highmaul_kills_mythic, blackrock_kills_normal, blackrock_kills_heroic, blackrock_kills_mythic, IsCurrent, rank) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)
		...
		blackrock_kills_mythic=VALUES(blackrock_kills_mythic), IsCurrent=VALUES(IsCurrent), rank=VALUES(rank)
	");

	$IsCurrent = 1;
	$stmt->bind_param("sssiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii",$name, $realm, $role, $class, $level, $ilvl, $ring_max, $heroicKills, $head, $neck, $shoulder, $back, $chest, $wrist, $hands, $waist, $legs, $feet, $ring1, $ring2, $trinket1, $trinket2, $mainhand, $offhand, $enchant_weapon, $enchant_neck, $enchant_cloak, $enchant_ring1, $enchant_ring2, $highmaul_normal_kills , $highmaul_heroic_kills , $highmaul_mythic_kills , $blackrock_normal_kills, $blackrock_heroic_kills, $blackrock_mythic_kills, $IsCurrent, $rank);
